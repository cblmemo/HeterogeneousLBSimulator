...
def setup_simulation(config: Dict[str, Any]):
    # Extract simulation settings
    simulation_settings = config.get('simulation', {})
    ...
    replicas = [
        replica_lib.Replica.make(
            ...
            location=utils.GeographicalRegion.get(replica.get('location')),
            accelerator=utils.AcceleratorType.get(replica.get('accelerator'))
